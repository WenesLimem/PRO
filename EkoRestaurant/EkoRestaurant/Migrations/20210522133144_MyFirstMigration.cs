        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTimeStartCooking = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateTimeFinished = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitAtStart = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: true),
                    IsVegan = table.Column<bool>(type: "bit", nullable: false),
                    ContainsArachides = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreparationTimeMinutes = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCommandElements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientCommandElements_ClientCommands_ClientCommandId",
                        column: x => x.ClientCommandId,
                        principalTable: "ClientCommands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClientCommandElements_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainDishId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyMenus_Recipes_DessertId",
                        column: x => x.DessertId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyMenus_Recipes_MainDishId",
                        column: x => x.MainDishId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyMenus_Recipes_StarterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientCommandElements_ClientCommandId",
                table: "ClientCommandElements",
                column: "ClientCommandId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientCommandElements_RecipeId",
                table: "ClientCommandElements",
                column: "RecipeId");
